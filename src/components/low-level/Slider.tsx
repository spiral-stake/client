...
const Slider = () => {
    ...
    <input onChange={handleChange} id="labels-range-input" type="range" value={value} min="1" max="5" step={1}  className="w-full h-2 rounded-lg appearance-auto  cursor-pointer dark:bg-gray-700 transition-all duration-300 ease-out"/>
